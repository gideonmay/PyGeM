...
project = 'PyGeM'
copyright = '2016, Filippo Salmoiraghi, Marco Tezzele'
...
latex_documents = [
  (master_doc, 'pygem.tex', 'pygem Documentation',
   'Filippo Salmoiraghi, Marco Tezzele', 'manual'),
]
...
man_pages = [
    (master_doc, 'pygem', 'pygem Documentation',
     [author], 1)
]
